...
<form action="<?= site_url('parrains') ?>" method="post" enctype="multipart/form-data" class="container mt-4 p-4 border rounded shadow-sm bg-light" style="max-width: 600px;">
    <?= csrf_field() ?>  <h3 class="mb-4 text-center">Ajouter un Parrain</h3>
    ...
    <div class="text-center">
        <button type="submit" class="btn btn-primary"> Ajouter le Parrain </button> </div>
